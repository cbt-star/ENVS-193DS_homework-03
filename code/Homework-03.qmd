...
My figure can look like a downwards sloping line that separates eggs below the line and chickens above the line. The size of the eggs decreases from left ot right while the size of the chickens increases from left to right. 

### b. Sketch

```{r}
knitr::include_graphics(here("data","affective_sketch.jpg"))
```

### c. Draft

```{r}
knitr::include_graphics(here("data","egg-viz-draft.png"))
```

### d. Artist statement

For now I am showing that there is a negative relationship between how much meat I eat and how many eggs I eat. The meat I eat is almost always chicken so I've chosen to represent meat with a chicken cartoon drawing. I am showing how each day I try to consume a certain amount of protein which largely comes from eggs, yogurt and chicken. Usually, eating more meat means I eat less eggs because my protein quota is being met by other sources. 

I had the affective visualization we looked at in lecture from The Pudding in my mind as inspiration. I really liked how they used a colorful background and animal cartoons to communicate their findings about the gender of anthropomorphized animals in children's books. I also liked the bright colors used in the Environmental Graphiti link and adopted some of that style while also adhering to my own linear thinking style.

My work is currently a digital drawing that I did on my ipad. 

I based my draft off of a plot I made with and meat consumption on the x-axis and egg consumption on the y-axis. I filled up the area under the line with eggs of decreasing sizes from left to right to show that egg consumption decreased. I filled up the area above the line with chickens of increasing size from left to right to show that meat consumption increases.  

### e. Materials to share in class

My [slides](https://docs.google.com/presentation/d/1N49U7fu8f7dHXLFLvfLhEWF8C29lOUHKn8ATaYnJ-rA/edit?slide=id.g3eb4e245ffe_0_1218#slide=id.g3eb4e245ffe_0_1218). 

## Problem 4: Statistical critique 

### a. Revisit and summarize

The authors are using an ANOVA to assess the effect of clearing on floral resources available for pollinators and on pollinator communities. The ANOVA
compares the variance within the cleared plots to the variance between the cleared and uncleared plots to assess whether or not there is a significant difference in floral resources and arthropods
...
**Figure 1:** “Boxplots of A) pollinator abundance, B) pollinator richness, C) Shannon index and
D) Simpson index for sampling-time (July, August) and treatment (C= cleared, NC=
not cleared).”
